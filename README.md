...
A static, responsive multi-page website built with plain **HTML, CSS and JavaScript** (no build tools, no frameworks required), covering the Cameroon Oncology Center home page, About/Leadership, six service detail pages, a Patients & Families hub, a Research/Education/Training page, a Directions page, and a functional appointment-request page — 12 pages in total, all fully bilingual (EN/FR).
...
| `medical-oncology.html` | Medical Oncology service page — treatments, cancers treated, team, impact stats |
